...
5. Run `node scripts/steam-achievements.js` in your command line. This will create an `achievements.json` file (or modify it if it already exists) at the location specified in `config.js`.
